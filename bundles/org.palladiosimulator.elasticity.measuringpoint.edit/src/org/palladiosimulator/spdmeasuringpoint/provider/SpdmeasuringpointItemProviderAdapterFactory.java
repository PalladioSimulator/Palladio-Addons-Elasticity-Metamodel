...
public class SpdmeasuringpointItemProviderAdapterFactory extends SpdmeasuringpointAdapterFactory
    ...
    public Adapter createElasticInfrastructureMeasuringPointAdapter() {
        if (this.elasticInfrastructureMeasuringPointItemProvider == null) {
            this.elasticInfrastructureMeasuringPointItemProvider = new ElasticInfrastructureMeasuringPointItemProvider(
                    this);
        }

        return this.elasticInfrastructureMeasuringPointItemProvider;
    }
    ...
    public void dispose() {
        if (this.elasticInfrastructureMeasuringPointItemProvider != null) {
            this.elasticInfrastructureMeasuringPointItemProvider.dispose();
        }
        if (this.serviceGroupMeasuringPointItemProvider != null) {
