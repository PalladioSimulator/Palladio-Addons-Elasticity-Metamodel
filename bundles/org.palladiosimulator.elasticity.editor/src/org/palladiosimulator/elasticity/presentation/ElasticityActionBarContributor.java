...
/**
 * This is the action bar contributor for the Elasticity model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class ElasticityActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        @Override
        public void run() {
            if (ElasticityActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) ElasticityActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
     ...
     * @generated
     */
    public ElasticityActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        ...
        toolBarManager.add(new Separator("elasticity-settings"));
        toolBarManager.add(new Separator("elasticity-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ScalingPolicyDefinitionEditorPlugin.INSTANCE.getString("_UI_ElasticityEditor_menu"),
