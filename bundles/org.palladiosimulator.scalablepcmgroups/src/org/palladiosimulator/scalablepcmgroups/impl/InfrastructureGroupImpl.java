...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Infrastructure Group</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.scalablepcmgroups.impl.InfrastructureGroupImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link org.palladiosimulator.scalablepcmgroups.impl.InfrastructureGroupImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.palladiosimulator.scalablepcmgroups.impl.InfrastructureGroupImpl#getLinkingResource <em>Linking Resource</em>}</li>
 *   <li>{@link org.palladiosimulator.scalablepcmgroups.impl.InfrastructureGroupImpl#getResourceEnvironment <em>Resource Environment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InfrastructureGroupImpl extends TargetGroupImpl implements InfrastructureGroup {
    ...
    protected EClass eStaticClass() {
        return scalablepcmgroupsPackage.Literals.INFRASTRUCTURE_GROUP;
    }
        ...
        if (unit != null && unit.eIsProxy()) {
            ...
            if (unit != oldUnit) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__UNIT, oldUnit, unit));
            }
        }
        return unit;
    }
    ...
    public void setUnit(ResourceContainer newUnit) {
        ...
        unit = newUnit;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__UNIT, oldUnit, unit));
    }
    ...
    public EList<ResourceContainer> getElements() {
        if (elements == null) {
            elements = new EObjectResolvingEList<ResourceContainer>(ResourceContainer.class, this, scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__ELEMENTS);
        }
        return elements;
    }
    ...
    public LinkingResource getLinkingResource() {
        if (linkingResource != null && linkingResource.eIsProxy()) {
            ...
            if (linkingResource != oldLinkingResource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__LINKING_RESOURCE, oldLinkingResource, linkingResource));
            }
        }
    ...
    public void setLinkingResource(LinkingResource newLinkingResource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__LINKING_RESOURCE, oldLinkingResource, linkingResource));
    }
    ...
    public ResourceEnvironment getResourceEnvironment() {
        if (resourceEnvironment != null && resourceEnvironment.eIsProxy()) {
            ...
            if (resourceEnvironment != oldResourceEnvironment) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__RESOURCE_ENVIRONMENT, oldResourceEnvironment, resourceEnvironment));
            }
        }
    ...
    public void setResourceEnvironment(ResourceEnvironment newResourceEnvironment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__RESOURCE_ENVIRONMENT, oldResourceEnvironment, resourceEnvironment));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__UNIT:
                if (resolve) return getUnit();
                return basicGetUnit();
            case scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__ELEMENTS:
                return getElements();
            case scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__LINKING_RESOURCE:
                if (resolve) return getLinkingResource();
                return basicGetLinkingResource();
            case scalablepcmgroupsPackage.INFRASTRUCTURE_GROUP__RESOURCE_ENVIRONMENT:
