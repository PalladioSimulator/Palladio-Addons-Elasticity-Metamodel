 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.scalablepcmgroups.impl.QueueImpl#getPassiveResourceQueueMessages <em>Passive Resource Queue Messages</em>}</li>
 *   <li>{@link org.palladiosimulator.scalablepcmgroups.impl.QueueImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.palladiosimulator.scalablepcmgroups.impl.QueueImpl#getUsageScenarioForConsumption <em>Usage Scenario For Consumption</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QueueImpl extends MinimalEObjectImpl.Container implements Queue {
        ...
        if (passiveResourceQueueMessages != null && passiveResourceQueueMessages.eIsProxy()) {
            ...
            if (passiveResourceQueueMessages != oldPassiveResourceQueueMessages) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, scalablepcmgroupsPackage.QUEUE__PASSIVE_RESOURCE_QUEUE_MESSAGES, oldPassiveResourceQueueMessages, passiveResourceQueueMessages));
            }
        }
    ...
    public void setPassiveResourceQueueMessages(PassiveResource newPassiveResourceQueueMessages) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, scalablepcmgroupsPackage.QUEUE__PASSIVE_RESOURCE_QUEUE_MESSAGES, oldPassiveResourceQueueMessages, passiveResourceQueueMessages));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, scalablepcmgroupsPackage.QUEUE__NAME, oldName, name));
    }
    ...
    public UsageScenario getUsageScenarioForConsumption() {
        if (usageScenarioForConsumption != null && usageScenarioForConsumption.eIsProxy()) {
            ...
            if (usageScenarioForConsumption != oldUsageScenarioForConsumption) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, scalablepcmgroupsPackage.QUEUE__USAGE_SCENARIO_FOR_CONSUMPTION, oldUsageScenarioForConsumption, usageScenarioForConsumption));
            }
        }
    ...
    public void setUsageScenarioForConsumption(UsageScenario newUsageScenarioForConsumption) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, scalablepcmgroupsPackage.QUEUE__USAGE_SCENARIO_FOR_CONSUMPTION, oldUsageScenarioForConsumption, usageScenarioForConsumption));
    }
