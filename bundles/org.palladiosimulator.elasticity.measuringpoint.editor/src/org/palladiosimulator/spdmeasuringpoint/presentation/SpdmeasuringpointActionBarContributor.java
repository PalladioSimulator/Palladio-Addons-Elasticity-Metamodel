...
/**
 * This is the action bar contributor for the Spdmeasuringpoint model editor. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class SpdmeasuringpointActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                SpdmeasuringpointActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return SpdmeasuringpointActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (SpdmeasuringpointActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) SpdmeasuringpointActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
