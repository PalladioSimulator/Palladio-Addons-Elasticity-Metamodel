...
/**
 * This is the action bar contributor for the ScalablePCMGroupMeasuringPoint model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ScalablePCMGroupMeasuringPointActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
            ScalablePCMGroupMeasuringPointEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                ScalablePCMGroupMeasuringPointActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
            ScalablePCMGroupMeasuringPointEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return ScalablePCMGroupMeasuringPointActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (ScalablePCMGroupMeasuringPointActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) ScalablePCMGroupMeasuringPointActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
     ...
     * @generated
     */
    public ScalablePCMGroupMeasuringPointActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        ...
        toolBarManager.add(new Separator("scalablepcmgroupmeasuringpoint-settings"));
        toolBarManager.add(new Separator("scalablepcmgroupmeasuringpoint-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                ScalablePCMGroupMeasuringPointEditorPlugin.INSTANCE
                    .getString("_UI_ScalablePCMGroupMeasuringPointEditor_menu"),
                "org.palladiosimulator.scalablepcmgroupmeasuringpointMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                ScalablePCMGroupMeasuringPointEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                ScalablePCMGroupMeasuringPointEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
