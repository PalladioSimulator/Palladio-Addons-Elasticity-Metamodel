 ...
 */
package org.palladiosimulator.elasticity.adjustments;
 ...
 * <!-- end-user-doc -->
 *
 * @see org.palladiosimulator.elasticity.adjustments.AdjustmentsFactory
 * @model kind="package"
 * @generated
 */
public interface AdjustmentsPackage extends EPackage {
     ...
     * @generated
     */
    AdjustmentsPackage eINSTANCE = org.palladiosimulator.elasticity.adjustments.impl.AdjustmentsPackageImpl.init();
    ...
    /**
     * The meta object id for the
     * '{@link org.palladiosimulator.elasticity.adjustments.impl.StepAdjustmentImpl <em>Step
     * Adjustment</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see org.palladiosimulator.elasticity.adjustments.impl.StepAdjustmentImpl
     * @see org.palladiosimulator.elasticity.adjustments.impl.AdjustmentsPackageImpl#getStepAdjustment()
     * @generated
     */
    ...
    /**
     * Returns the meta object for class
     * '{@link org.palladiosimulator.elasticity.adjustments.RelativeAdjustment <em>Relative
     * Adjustment</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for class '<em>Relative Adjustment</em>'.
     * @see org.palladiosimulator.elasticity.adjustments.RelativeAdjustment
     * @generated
     */
     ...
     * '{@link org.palladiosimulator.elasticity.adjustments.RelativeAdjustment#getPercentageGrowthValue
     ...
     * @see org.palladiosimulator.elasticity.adjustments.RelativeAdjustment#getPercentageGrowthValue()
    ...
    /**
     * Returns the meta object for the attribute
     * '{@link org.palladiosimulator.elasticity.adjustments.RelativeAdjustment#getMinAdjustmentValue
     ...
     * @see org.palladiosimulator.elasticity.adjustments.RelativeAdjustment#getMinAdjustmentValue()
     * @see #getRelativeAdjustment()
     * @generated
     */
    ...
    /**
     * Returns the meta object for class
     * '{@link org.palladiosimulator.elasticity.adjustments.AbsoluteAdjustment <em>Absolute
     * Adjustment</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for class '<em>Absolute Adjustment</em>'.
     * @see org.palladiosimulator.elasticity.adjustments.AbsoluteAdjustment
     * @generated
     */
    ...
    /**
     * Returns the meta object for the attribute
     * '{@link org.palladiosimulator.elasticity.adjustments.AbsoluteAdjustment#getGoalValue <em>Goal
     * Value</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the attribute '<em>Goal Value</em>'.
     * @see org.palladiosimulator.elasticity.adjustments.AbsoluteAdjustment#getGoalValue()
    ...
    /**
     * Returns the meta object for the attribute
     * '{@link org.palladiosimulator.elasticity.adjustments.StepAdjustment#getStepValue <em>Step
     * Value</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the attribute '<em>Step Value</em>'.
     * @see org.palladiosimulator.elasticity.adjustments.StepAdjustment#getStepValue()
