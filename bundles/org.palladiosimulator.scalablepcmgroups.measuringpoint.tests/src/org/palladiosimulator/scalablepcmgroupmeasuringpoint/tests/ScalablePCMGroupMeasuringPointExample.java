...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>scalablepcmgroupmeasuringpoint</b></em>'
 * package. <!-- end-user-doc -->
 *
 * @generated
 */
public class ScalablePCMGroupMeasuringPointExample {
    /**
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(ScalablePCMGroupMeasuringPointPackage.eNS_URI, ScalablePCMGroupMeasuringPointPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet
                    .createResource(URI.createURI("http:///My.scalablepcmgroupmeasuringpoint"));
                final InfrastructureGroupMeasuringPoint root = ScalablePCMGroupMeasuringPointFactory.eINSTANCE
                    .createInfrastructureGroupMeasuringPoint();
...
} // ScalablePCMGroupMeasuringPointExample
