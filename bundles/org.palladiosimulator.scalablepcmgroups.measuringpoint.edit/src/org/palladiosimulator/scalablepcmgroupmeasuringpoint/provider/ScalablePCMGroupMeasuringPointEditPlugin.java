...
/**
 * This is the central singleton for the ScalablePCMGroupMeasuringPoint edit plugin. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public final class ScalablePCMGroupMeasuringPointEditPlugin extends EMFPlugin {
    /**
     * Keep track of the singleton. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public static final ScalablePCMGroupMeasuringPointEditPlugin INSTANCE = new ScalablePCMGroupMeasuringPointEditPlugin();
