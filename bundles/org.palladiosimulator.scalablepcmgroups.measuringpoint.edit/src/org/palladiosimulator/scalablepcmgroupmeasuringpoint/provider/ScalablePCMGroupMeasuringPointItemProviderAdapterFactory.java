...
import org.palladiosimulator.scalablepcmgroupmeasuringpoint.util.ScalablePCMGroupMeasuringPointAdapterFactory;
 ...
 * @generated
 */
public class ScalablePCMGroupMeasuringPointItemProviderAdapterFactory
        extends ScalablePCMGroupMeasuringPointAdapterFactory
     ...
     * @generated
     */
    public ScalablePCMGroupMeasuringPointItemProviderAdapterFactory() {
     ...
     * @generated
     */
    protected InfrastructureGroupMeasuringPointItemProvider infrastructureGroupMeasuringPointItemProvider;
    ...
    public Adapter createInfrastructureGroupMeasuringPointAdapter() {
        if (this.infrastructureGroupMeasuringPointItemProvider == null) {
            this.infrastructureGroupMeasuringPointItemProvider = new InfrastructureGroupMeasuringPointItemProvider(
                    this);
        }

        return this.infrastructureGroupMeasuringPointItemProvider;
    }
    ...
    public Adapter createServiceGroupMeasuringPointAdapter() {
        if (this.serviceGroupMeasuringPointItemProvider == null) {
            this.serviceGroupMeasuringPointItemProvider = new ServiceGroupMeasuringPointItemProvider(this);
        }

        return this.serviceGroupMeasuringPointItemProvider;
    }
    ...
    public Adapter createCompetingConsumerGroupMeasuringPointAdapter() {
        if (this.competingConsumerGroupMeasuringPointItemProvider == null) {
            this.competingConsumerGroupMeasuringPointItemProvider = new CompetingConsumerGroupMeasuringPointItemProvider(
                    this);
        }

        return this.competingConsumerGroupMeasuringPointItemProvider;
    }
    ...
    public void dispose() {
        if (this.infrastructureGroupMeasuringPointItemProvider != null) {
            this.infrastructureGroupMeasuringPointItemProvider.dispose();
        }
        if (this.serviceGroupMeasuringPointItemProvider != null) {
            this.serviceGroupMeasuringPointItemProvider.dispose();
        }
        if (this.competingConsumerGroupMeasuringPointItemProvider != null) {
            this.competingConsumerGroupMeasuringPointItemProvider.dispose();
        }
    }
        ...
        protected static class CreationSwitch extends MeasuringpointSwitch<Object> {
            ...
            public Object caseMeasuringPointRepository(final MeasuringPointRepository object) {
                this.newChildDescriptors.add(this.createChildParameter(
                        ...
                        ScalablePCMGroupMeasuringPointFactory.eINSTANCE.createInfrastructureGroupMeasuringPoint()));

                this.newChildDescriptors.add(this.createChildParameter(
                        MeasuringpointPackage.Literals.MEASURING_POINT_REPOSITORY__MEASURING_POINTS,
                        ScalablePCMGroupMeasuringPointFactory.eINSTANCE.createServiceGroupMeasuringPoint()));

                this.newChildDescriptors.add(this.createChildParameter(
                        MeasuringpointPackage.Literals.MEASURING_POINT_REPOSITORY__MEASURING_POINTS,
                        ScalablePCMGroupMeasuringPointFactory.eINSTANCE.createCompetingConsumerGroupMeasuringPoint()));
