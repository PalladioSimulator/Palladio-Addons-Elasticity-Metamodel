 ...
 * @generated
 */
public class SemanticelasticityPackageImpl extends EPackageImpl implements SemanticelasticityPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @see org.palladiosimulator.semanticelasticityspec.SemanticelasticityPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private SemanticelasticityPackageImpl() {
        super(eNS_URI, SemanticelasticityFactory.eINSTANCE);
    }
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     *
     * <p>This method is used to initialize {@link SemanticelasticityPackage#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static SemanticelasticityPackage init() {
        if (isInited) return (SemanticelasticityPackage)EPackage.Registry.INSTANCE.getEPackage(SemanticelasticityPackage.eNS_URI);

        // Obtain or create and register package
        Object registeredSemanticelasticityPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
        SemanticelasticityPackageImpl theSemanticelasticityPackage = registeredSemanticelasticityPackage instanceof SemanticelasticityPackageImpl ? (SemanticelasticityPackageImpl)registeredSemanticelasticityPackage : new SemanticelasticityPackageImpl();
        ...
        theSemanticelasticityPackage.createPackageContents();

        // Initialize created meta-data
        theSemanticelasticityPackage.initializePackageContents();

        // Mark meta-data to indicate it can't be changed
        theSemanticelasticityPackage.freeze();

        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(SemanticelasticityPackage.eNS_URI, theSemanticelasticityPackage);
        return theSemanticelasticityPackage;
    }
     ...
     */
    @Override
    public EReference getConfiguration_ElasticitySpec() {
     ...
     */
    @Override
    public SemanticelasticityFactory getSemanticelasticityFactory() {
        return (SemanticelasticityFactory)getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        createEReference(configurationEClass, CONFIGURATION__ELASTICITY_SPEC);
    ...
    public void initializePackageContents() {
        ...
        initEReference(getConfiguration_ElasticitySpec(), theElasticityPackage.getElasticitySpec(), null, "elasticitySpec", null, 0, 1, Configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getConfiguration_EnactedPolicy(), theElasticityPackage.getScalingPolicy(), null, "enactedPolicy", null, 0, 1, Configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getTargetGroupCfg_EnactedPolicies(), theElasticityPackage.getScalingPolicy(), null, "enactedPolicies", null, 0, -1, TargetGroupCfg.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
