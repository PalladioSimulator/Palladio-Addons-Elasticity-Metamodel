 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.semanticelasticityspec.impl.ElasticInfrastructureCfgImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link org.palladiosimulator.semanticelasticityspec.impl.ElasticInfrastructureCfgImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.palladiosimulator.semanticelasticityspec.impl.ElasticInfrastructureCfgImpl#getLinkingResource <em>Linking Resource</em>}</li>
 *   <li>{@link org.palladiosimulator.semanticelasticityspec.impl.ElasticInfrastructureCfgImpl#getResourceEnvironment <em>Resource Environment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElasticInfrastructureCfgImpl extends TargetGroupCfgImpl implements ElasticInfrastructureCfg {
	...
	protected EClass eStaticClass() {
        return SemanticelasticityPackage.Literals.ELASTIC_INFRASTRUCTURE_CFG;
    }
        ...
        if (unit != null && unit.eIsProxy()) {
            ...
            if (unit != oldUnit) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__UNIT, oldUnit, unit));
            }
        }
        return unit;
    }
    ...
    public void setUnit(ResourceContainer newUnit) {
        ...
        unit = newUnit;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__UNIT, oldUnit, unit));
    }
    ...
    public EList<ResourceContainer> getElements() {
        if (elements == null) {
            elements = new EObjectResolvingEList<ResourceContainer>(ResourceContainer.class, this, SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__ELEMENTS);
        }
        return elements;
    }
    ...
    public LinkingResource getLinkingResource() {
        if (linkingResource != null && linkingResource.eIsProxy()) {
            ...
            if (linkingResource != oldLinkingResource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__LINKING_RESOURCE, oldLinkingResource, linkingResource));
            }
        }
    ...
    public void setLinkingResource(LinkingResource newLinkingResource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__LINKING_RESOURCE, oldLinkingResource, linkingResource));
    }
    ...
    public ResourceEnvironment getResourceEnvironment() {
        if (resourceEnvironment != null && resourceEnvironment.eIsProxy()) {
            ...
            if (resourceEnvironment != oldResourceEnvironment) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__RESOURCE_ENVIRONMENT, oldResourceEnvironment, resourceEnvironment));
            }
        }
    ...
    public void setResourceEnvironment(ResourceEnvironment newResourceEnvironment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__RESOURCE_ENVIRONMENT, oldResourceEnvironment, resourceEnvironment));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__UNIT:
                if (resolve) return getUnit();
                return basicGetUnit();
            case SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__ELEMENTS:
                return getElements();
            case SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__LINKING_RESOURCE:
                if (resolve) return getLinkingResource();
                return basicGetLinkingResource();
            case SemanticelasticityPackage.ELASTIC_INFRASTRUCTURE_CFG__RESOURCE_ENVIRONMENT:
