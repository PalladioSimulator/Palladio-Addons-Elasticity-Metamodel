 ...
 */
package org.palladiosimulator.elasticity.constraints.policy.tests;

import org.palladiosimulator.elasticity.constraints.policy.PolicyConstraint;
import org.palladiosimulator.elasticity.constraints.tests.AbstractConstraintTest;
...
public abstract class PolicyConstraintTest extends AbstractConstraintTest {
     ...
     * @generated
     */
    public PolicyConstraintTest(final String name) {
        super(name);
    }
    ...
    protected PolicyConstraint getFixture() {
        return (PolicyConstraint) this.fixture;
    }
