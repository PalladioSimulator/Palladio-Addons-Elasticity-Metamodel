...
public class SpdmeasuringpointExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getPackageRegistry()
            .put(SpdmeasuringpointPackage.eNS_URI, SpdmeasuringpointPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.spdmeasuringpoint"));
                final ElasticInfrastructureMeasuringPoint root = SpdmeasuringpointFactory.eINSTANCE
